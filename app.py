...
def chat(user_id):
    ...
    intents = {
        'Recomendación de hoy': '¿Cuál es la recomendación de película para hoy?',
        'Género favorito': f'Recomiéndame una película de {user.genero_favorito}',
        'Sorpresa': 'Sorpréndeme con una película',
